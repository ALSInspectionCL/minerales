...
class Fluidez(models.Model):
    ...
    idSolicitud = models.CharField(max_length=50,blank=True, null=True)
    nLata1 = models.CharField(max_length=50,blank=True, null=True)
    nLata2 = models.CharField(max_length=50,blank=True, null=True)
    pLata1 = models.DecimalField(max_digits=20, decimal_places=3, blank=True, null=True)
    pLata2 = models.DecimalField(max_digits=20, decimal_places=3, blank=True, null=True)
    pBrutoHumedo1 = models.DecimalField(max_digits=20, decimal_places=3, blank=True, null=True)
    pBrutoHumedo2 = models.DecimalField(max_digits=20, decimal_places=3, blank=True, null=True)
    pBrutoSeco1 = models.DecimalField(max_digits=20, decimal_places=3, blank=True, null=True)
    pBrutoSeco2 = models.DecimalField(max_digits=20, decimal_places=3, blank=True, null=True)
    porcHumedad1 = models.DecimalField(max_digits=20, decimal_places=5, blank=True, null=True)
    porcHumedad2 = models.DecimalField(max_digits=20, decimal_places=5, blank=True, null=True)
...
class PruebaFluidez(models.Model):
    ...
    pLata1 = models.DecimalField(max_digits=20, decimal_places=3, blank=True, null=True)
    pLata2 = models.DecimalField(max_digits=20, decimal_places=3, blank=True, null=True)
    pMuestraHumedo1 = models.DecimalField(max_digits=20, decimal_places=3, blank=True, null=True)
    pMuestraHumedo2 = models.DecimalField(max_digits=20, decimal_places=3, blank=True, null=True)
    pBrutoHumedo1 = models.DecimalField(max_digits=20, decimal_places=3, blank=True, null=True)
    pBrutoHumedo2 = models.DecimalField(max_digits=20, decimal_places=3, blank=True, null=True)
    pBrutoSeco1 = models.DecimalField(max_digits=20, decimal_places=3, blank=True, null=True)
    pBrutoSeco2 = models.DecimalField(max_digits=20, decimal_places=3, blank=True, null=True)
