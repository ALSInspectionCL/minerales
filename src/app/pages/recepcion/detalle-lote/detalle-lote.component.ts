...
exportToExcel(): void {
  ...
  const datos = this.dataSource1.map((dato) => {
    ...
    return {
      ...
      'Bruto Origen': Number(dato.brutoOrigen),
      'Tara Origen': Number(dato.taraOrigen),
      'Neto Húmedo Origen': Number(dato.netoHumedoOrigen),
      ...
      'Bruto Destino': Number(dato.brutoDestino),
      'Tara Destino': Number(dato.taraDestino),
      'Neto Húmedo Destino': Number(dato.netoHumedoDestino),
      'Diferencia Húmeda': Number(dato.diferenciaHumeda),
      'Diferencia Seca': Number(dato.diferenciaSeca),
      'Cu Fino': Number(dato.CuFino),
