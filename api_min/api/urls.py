...
from .views import obtener_lotes_por_fechas, ConvertExcelToPDF
...
router.register(r'pesajes', views.PesajeViewSet)
...
urlpatterns=[
    ...
    path('convertirexcelpdf/', ConvertExcelToPDF.as_view()),
]
