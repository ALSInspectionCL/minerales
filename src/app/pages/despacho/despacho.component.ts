...
export class DespachoComponent {
  ...
  cargarLotes() {
    ...
    if (
      ...
      const apiUrl = `http://127.0.0.1:8000/api/lote-despacho/?solicitud=${this.idSolicitud}&servicio=${this.idServicio}/`;
...
export class CrearLoteDialog {
  ...
  crearNuevoLote() {
    if (this.loteForm.valid) {
      ...
      const apiUrl = 'http://127.0.0.1:8000/api/lote-despacho/';
