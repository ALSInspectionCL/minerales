...
SECRET_KEY = 'django-insecure-gshqtd)2)c%gerbv5s5k=3)kc2p!$%h06)ziiyy(%+tkjztckj'
...
DATABASES = {
    ...
    #     'NAME': 'als_min',
    #     'USER': 'Matias',
    #     'PASSWORD': '123456',  # Asegúrate de que esta sea la contraseña correcta
    #     'HOST': 'localhost',
    #     'PORT': '3306',
    # }
