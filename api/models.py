...
class Bodega(models.Model):
    ...
    total = models.DecimalField(max_digits=20, decimal_places=3, blank=True)
...
class Lote(models.Model):
    ...
    porcHumedad = models.DecimalField(max_digits=5, decimal_places=3, blank=True)
...
class RecepcionTransporte(models.Model):
    ...
    brutoOrigen = models.DecimalField(max_digits=20, decimal_places=3, blank=True, null=True)
    taraOrigen = models.DecimalField(max_digits=20, decimal_places=3, blank=True, null=True)
    netoHumedoOrigen = models.DecimalField(max_digits=20, decimal_places=3, blank=True, null=True)
    ...
    brutoDestino = models.DecimalField(max_digits=20, decimal_places=3, blank=True, null=True)
    taraDestino = models.DecimalField(max_digits=20, decimal_places=3, blank=True, null=True)
    netoHumedoDestino = models.DecimalField(max_digits=20, decimal_places=3, blank=True, null=True)
    diferenciaHumeda = models.DecimalField(max_digits=20, decimal_places=3, blank=True, null=True)
    diferenciaSeca = models.DecimalField(max_digits=20, decimal_places=3, blank=True, null=True)
...
class DespachoCamion(models.Model):
    ...
    sellosOrigen = models.CharField(max_length=200,blank=True, null=True)
    netoHumedoOrigen = models.DecimalField(max_digits=20, decimal_places=3, blank=True)
    ...
    brutoDestino = models.DecimalField(max_digits=20, decimal_places=3, blank=True)
    taraDestino = models.DecimalField(max_digits=20, decimal_places=3, blank=True)
    netoHumedoDestino = models.DecimalField(max_digits=20, decimal_places=3, blank=True)
    diferenciaHumeda = models.DecimalField(max_digits=20, decimal_places=3, blank=True)
    diferenciaSeca = models.DecimalField(max_digits=20, decimal_places=3, blank=True)
    CuFino = models.DecimalField(max_digits=20, decimal_places=3, blank=True, null=True)
    bodega = models.ForeignKey(Bodega, on_delete=models.CASCADE)
    estado = models.CharField(max_length=20)
...
class DespachoEmbarque(models.Model):
    ...
    CuFino = models.DecimalField(max_digits=20, decimal_places=3, blank=True, null=True)
    pesoLote = models.DecimalField(decimal_places=3,max_digits=10) #Diferencia entre odometroInicial y odometroFinal
    porcHumedad = models.DecimalField(decimal_places=3,max_digits=10) #Porcentaje de humedad de sub Lote
    estado = models.CharField(max_length=20)
...
class DetalleBodega(models.Model):
    ...
    ingreso = models.DecimalField(max_digits=20, decimal_places=3, blank=True)
    despacho = models.DecimalField(max_digits=20, decimal_places=3, blank=True)
...
class TrazabilidadMecanica(models.Model):
    ...
    pesoNetoHumedo = models.DecimalField(max_digits=20, decimal_places=3, blank=True, null=True)
    pesoNetoSeco = models.DecimalField(max_digits=20, decimal_places=3, blank=True, null=True)
    porcHumedad = models.DecimalField(max_digits=20, decimal_places=3, blank=True, null=True)
